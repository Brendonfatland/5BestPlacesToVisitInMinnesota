...
var dataArray = [
  {
    myLatLng: {lat: 44.9781, lng: 266.744},
  ...
  {
    myLatLng: {lat: 44.8549, lng: 266.758},
  ...
  {
    myLatLng: {lat: 46.7867, lng: 267.91},
    title: 'Duluth',
  ...
  {
    myLatLng: {lat: 44.767, lng: 266.805},
    title: 'Minnesota Zoo',
  ...
  {
    myLatLng: {lat: 44.866, lng: 266.672},
...
function initMap() {
  map = new google.maps.Map(document.getElementById('map'), {
    center: new google.maps.LatLng(46.2,266.6), // MN
    zoom: 7
  });
